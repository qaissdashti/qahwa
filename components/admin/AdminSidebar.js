      ...
      <div className="flex-1">
        <div className="flex items-start justify-between gap-2 px-2 mb-6">
          <div className="flex items-start gap-2">
            <Logo size={28} />
            <div>
              <span className="text-xl font-extrabold block leading-none" style={{ fontFamily: 'var(--font-sans)' }}>{t('admin.brand')}</span>
              <span className="block text-xs text-qahwa-accent font-bold mt-1">{t('admin.label')}</span>
            </div>
          </div>
